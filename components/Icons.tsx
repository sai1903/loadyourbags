...
export const SunIcon: React.FC<IconProps> = ({ className, onClick }) => (
...
export const MoonIcon: React.FC<IconProps> = ({ className, onClick }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} onClick={onClick}>
...
export const ShoppingBagIcon: React.FC<IconProps> = ({ className, onClick }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} onClick={onClick}>
...
export const SparklesIcon: React.FC<IconProps> = ({ className, onClick }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} onClick={onClick}>
...
export const MinusIcon: React.FC<IconProps> = ({ className, onClick }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} onClick={onClick}>
...
export const HeartIcon: React.FC<IconProps & { filled?: boolean }> = ({ className, filled, ...props }) => (
...
export const StarIcon: React.FC<IconProps & { filled?: boolean }> = ({ className, filled = true, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={filled ? 0 : 1.5} className={className} {...props}>
...
export const UsersIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.57-.063 1.14-.094 1.74-.094 2.261 0 4.129.586 5.5 1.48m-8.681.43A9.086 9.086 0 0112 15.75c.611 0 1.21.056 1.785.158m-6.558.289A9.054 9.054 0 016 18.72m12 0a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72M12 12.75a4.5 4.5 0 100-9 4.5 4.5 0 000 9z" />
    </svg>
);
...
export const PencilSquareIcon: React.FC<IconProps> = ({ className, onClick }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} onClick={onClick}>
...
export const CreditCardIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3.375M3 18.75V7.25A2.25 2.25 0 015.25 5h13.5A2.25 2.25 0 0121 7.25v11.5A2.25 2.25 0 0118.75 21H5.25A2.25 2.25 0 013 18.75z" />
    </svg>
);

export const UpiIcon: React.FC<IconProps> = ({ className }) => (
     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m7.5-3h3V9h-3v6z" />
...
export const QrCodeIcon: React.FC<IconProps> = ({ className }) => (
     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 8.25h.01M12 8.25h.01M15.75 8.25h.01M8.25 12h.01M12 12h.01M15.75 12h.01M8.25 15.75h.01M12 15.75h.01M15.75 15.75h.01" />
    </svg>
);